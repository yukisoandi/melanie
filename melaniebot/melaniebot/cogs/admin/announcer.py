...
class Announcer:
    def __init__(self, ctx: commands.Context, message: str, config=None) -> None:
        """:param ctx:
        :param message:
    ...
    async def announcer(self):
        ...
        if failed:
            msg = "I could not announce to the following server: " if len(failed) == 1 else ("I could not announce to the following servers: ")
