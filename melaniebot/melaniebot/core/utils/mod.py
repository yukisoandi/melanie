...
async def is_mod_or_superior(bot: Melanie, obj: Union[discord.Message, discord.Member, discord.Role]):
...
async def is_admin_or_superior(bot: Melanie, obj: Union[discord.Message, discord.Member, discord.Role]):
