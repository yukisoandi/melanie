...
__all__ = ["ConversionFailure", "BotMissingPermissions", "UserFeedbackCheckFailure", "ArgParserFailure"]


class ConversionFailure(commands.BadArgument):
    """Raised when converting an argument fails."""

    def __init__(self, converter, argument: str, param: inspect.Parameter, *args) -> None:
...
class BotMissingPermissions(commands.CheckFailure):
    ...
    def __init__(self, missing: discord.Permissions, *args) -> None:
...
class ArgParserFailure(UserFeedbackCheckFailure):
    ...
    def __init__(self, cmd: str, user_input: str, custom_help: str = None, ctx_send_help: bool = False) -> None:
        self.cmd = cmd
...
commands.errors.ConversionFailure = ConversionFailure
commands.errors.ArgParserFailure = ArgParserFailure
