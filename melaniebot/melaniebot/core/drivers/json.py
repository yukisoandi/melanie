...
from melaniebot.core import data_manager, errors
...
class JsonDriver(BaseDriver):
    ...
    def __init__(self, cog_name: str, identifier: str, *, data_path_override: Optional[Path] = None, file_name_override: str = "settings.json") -> None:
