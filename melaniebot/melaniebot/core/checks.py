...
def is_mod_or_superior(ctx: Context) -> Awaitable[bool]:
    warnings.warn(
        "`melaniebot.core.checks.is_mod_or_superior` is deprecated and will be removed in a future release, please use `melaniebot.core.utils.mod.is_mod_or_superior` instead.",
...
def is_admin_or_superior(ctx: Context) -> Awaitable[bool]:
    warnings.warn(
        "`melaniebot.core.checks.is_admin_or_superior` is deprecated and will be removed in a future release, please use `melaniebot.core.utils.mod.is_admin_or_superior` instead.",
        category=DeprecationWarning,
        stacklevel=2,
    )
...
def check_permissions(ctx: Context, perms: dict[str, bool]) -> Awaitable[bool]:
    warnings.warn(
        "`melaniebot.core.checks.check_permissions` is deprecated and will be removed in a future release, please use `melaniebot.core.utils.mod.check_permissions`.",
        DeprecationWarning,
        stacklevel=2,
    )
