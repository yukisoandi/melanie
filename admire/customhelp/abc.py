...
class ThemesMeta:
    ...
    def __init_subclass__(cls, *args, **kw):
        ...
        ALL_FEATURES = ("format_cog_help", "format_category_help", "format_bot_help", "format_command_help")
        ...
        for name, attr in cls.__dict__.items():
            ...
            msg = f"Method {name} defined in {cls.__name__}  does not exist in superclasses"
            raise TypeError(msg)
