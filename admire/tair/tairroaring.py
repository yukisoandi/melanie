...
class TairRoaringCommands(CommandsProtocol):
    ...
    def tr_bitop(self, destkey: KeyT, operation: str, keys: Iterable[KeyT]) -> ResponseT:
    ...
    def tr_bitcount(self, key: KeyT, start: Optional[int] = None, end: Optional[int] = None) -> ResponseT:
    ...
    def tr_bitpos(self, key: KeyT, value: int, count: Optional[int] = None) -> ResponseT:
    ...
    def tr_scan(self, key: KeyT, start_offset: int, count: Optional[int] = None) -> ResponseT:
