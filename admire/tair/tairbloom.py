...
class TairBloomCommands(CommandsProtocol):
    def bf_reserve(self, key: KeyT, error_rate: float, capacity: int) -> ResponseT:
    ...
    def bf_insert(
        self, key: KeyT, items: Iterable[EncodableT], capacity: Optional[int] = None, error_rate: Optional[float] = None, nocreate: bool = False
    ) -> ResponseT:
