...
class User:
    ...
    def default_avatar_url(self):
        return f"https://cdn.discordapp.com/embed/avatars/{(int(self.id) >> 22) % 5}.png"
...
class Message:
    ...
    def is_different_from(self, other):
        if self.timestamp_ is not None:
            return (other.timestamp_ - self.timestamp_).total_seconds() > 420 or other.timestamp_.day != self.timestamp_.day or other.author != self.author
