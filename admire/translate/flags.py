...
FLAGS: dict[str, Union[dict[str, str], dict[str, Optional[str]], dict[str, Union[int, str]]]] = {
    ...
    "🇬🇧": {"code": "en", "country": "United Kingdom of Great Britain and Northern Ireland", "name": "English"},
    ...
    "🇬🇸": {"code": "en", "country": "South Georgia and the South Sandwich Islands", "name": "English"},
    ...
    "🇲🇰": {"code": "mk", "country": "Macedonia (the former Yugoslav Republic of)", "name": "Macedonian"},
    ...
    "🇸🇭": {"code": "en", "country": "Saint Helena, Ascension and Tristan da Cunha", "name": "English"},
