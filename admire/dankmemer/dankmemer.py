...
class DankMemer(commands.Cog):
    ...
    def __init__(self, bot: Melanie) -> None:
        ...
        self.config.register_global(url="http://localhost:65535/api")
    ...
    async def send_error(self, ctx, data):
        log.error(f"Oops, an error occured. {data['error']}")
        raise ValueError({data["error"]})

    async def get(self, ctx, url, json: bool = False):
        async with ctx.typing(), self.session.get(self.api + url, headers=self.headers) as resp:
            if resp.status == 200:
                if json:
                ...
                return file
            if resp.status == 404:
                return {"error": "Server not found, ensure the correct URL is setup and is reachable. "}
            try:
                return await resp.json()
            except aiohttp.ContentTypeError:
                return {"error": "Server may be down, please try again later."}

    async def send_img(self, ctx, image) -> None:
    ...
    @commands.command()
    async def abandon(self, ctx, *, text: commands.clean_content(use_nicknames=True, remove_markdown=True, fix_channel_mentions=True)):
        """Abandoning your son?."""
    ...
    @commands.check(tokencheck)
    @commands.command()
    async def armor(self, ctx, *, text: commands.clean_content(use_nicknames=True, remove_markdown=True, fix_channel_mentions=True)):
    ...
    @commands.check(tokencheck)
    @commands.command()
    async def balloon(self, ctx, *, text: commands.clean_content(use_nicknames=True, remove_markdown=True, fix_channel_mentions=True)):
        """Pop a balloon.
    ...
    async def bed(self, ctx, user: discord.Member, user2: discord.Member = None):
        ...
        data = await self.get(
            ctx,
            f"""/bed?avatar1={user.avatar_url_as(static_format="png")}{f"&avatar2={user2.avatar_url_as(static_format='png')}" if user2 is not None else ""}""",
        )
    ...
    @commands.check(tokencheck)
    @commands.command()
    async def boo(self, ctx, *, text: commands.clean_content(use_nicknames=True, remove_markdown=True, fix_channel_mentions=True)):
        """Scary.
    ...
    @commands.check(tokencheck)
    @commands.command()
    async def brain(self, ctx, *, text: commands.clean_content(use_nicknames=True, remove_markdown=True, fix_channel_mentions=True)):
        """Big brain meme.
    ...
    async def byemom(
        ...
        *,
        text: commands.clean_content(use_nicknames=True, remove_markdown=True, fix_channel_mentions=True),
    ):
        """Bye mom.
        ...
        data = await self.get(ctx, f"/byemom?avatar1={user.avatar_url_as(static_format='png')}&username1={user.name}&text={text}")
        if isinstance(data, dict):
            return await self.send_error(ctx, data)
    ...
    @commands.check(tokencheck)
    @commands.command()
    async def changemymind(self, ctx, *, text: commands.clean_content(use_nicknames=True, remove_markdown=True, fix_channel_mentions=True)):
        """Change my mind?."""
        text = self.parse_text(text)
    ...
    @commands.check(tokencheck)
    @commands.command()
    async def cheating(self, ctx, *, text: commands.clean_content(use_nicknames=True, remove_markdown=True, fix_channel_mentions=True)):
        """Cheating?.
    ...
    @commands.check(tokencheck)
    @commands.command()
    async def crab(self, ctx, *, text: commands.clean_content(use_nicknames=True, remove_markdown=True, fix_channel_mentions=True)):
        """Crab rave.
    ...
    @commands.check(tokencheck)
    @commands.command()
    async def paperplease(self, ctx, *, text: commands.clean_content(use_nicknames=True, remove_markdown=True, fix_channel_mentions=True)):
    ...
    @commands.check(tokencheck)
    @commands.command()
    async def confusedcat(self, ctx, *, text: commands.clean_content(use_nicknames=True, remove_markdown=True, fix_channel_mentions=True)):
        """Confused cat meme.
    ...
    @commands.check(tokencheck)
    @commands.command()
    async def cry(self, ctx, *, text: commands.clean_content(use_nicknames=True, remove_markdown=True, fix_channel_mentions=True)):
        """Drink my tears meme.
    ...
    @commands.check(tokencheck)
    @commands.command(aliases=["deepfried"])
    async def deepfry(self, ctx, image: ImageFinder = None):
        """Deepfry an image."""
        if image is None:
            image = await ImageFinder().search_for_images(ctx)
        image = image[0]
    ...
    @commands.check(tokencheck)
    @commands.command()
    async def doglemon(self, ctx, *, text: commands.clean_content(use_nicknames=True, remove_markdown=True, fix_channel_mentions=True)):
        """Dog and Lemon Meme.
    ...
    @commands.check(tokencheck)
    @commands.command()
    async def door2(self, ctx, image: ImageFinder = None):
    ...
    @commands.check(tokencheck)
    @commands.command()
    async def excuseme(self, ctx, *, text: commands.clean_content(use_nicknames=True, remove_markdown=True, fix_channel_mentions=True)):
        """Excuse me, what the...
    ...
    @commands.check(tokencheck)
    @commands.command()
    async def expanddong(self, ctx, *, text: commands.clean_content(use_nicknames=True, remove_markdown=True, fix_channel_mentions=True)):
        """Expanding?.
    ...
    @commands.check(tokencheck)
    @commands.command()
    async def facts(self, ctx, *, text: commands.clean_content(use_nicknames=True, remove_markdown=True, fix_channel_mentions=True)):
        """Facts book.
    ...
    async def floor(
        ...
        *,
        ...
        text = self.parse_text(text)
        user = user or ctx.author
        data = await self.get(ctx, f"/floor?avatar1={user.avatar_url_as(static_format='png')}&text={text}")
        if isinstance(data, dict):
            return await self.send_error(ctx, data)
        data.name = "fedora.png"
        await self.send_img(ctx, discord.File(data))
    ...
    async def garfield(
        ...
        *,
        ...
        user = user or ctx.author
        text = self.parse_text(text)
        data = await self.get(ctx, f"/garfield?avatar1={user.avatar_url_as(static_format='png')}&text={text}")
        if isinstance(data, dict):
            return await self.send_error(ctx, data)
    ...
    @commands.check(tokencheck)
    @commands.command()
    async def humansgood(self, ctx, *, text: commands.clean_content(use_nicknames=True, remove_markdown=True, fix_channel_mentions=True)):
    ...
    @commands.check(tokencheck)
    @commands.command()
    async def inator(self, ctx, *, text: commands.clean_content(use_nicknames=True, remove_markdown=True, fix_channel_mentions=True)):
        """Xinator."""
        text = self.parse_text(text)
    ...
    @commands.check(tokencheck)
    @commands.command()
    async def justpretending(self, ctx, *, text: commands.clean_content(use_nicknames=True, remove_markdown=True, fix_channel_mentions=True)):
        """Playing dead.
    ...
    @commands.check(tokencheck)
    @commands.command()
    async def knowyourlocation(self, ctx, *, text: commands.clean_content(use_nicknames=True, remove_markdown=True, fix_channel_mentions=True)):
    ...
    @commands.check(tokencheck)
    @commands.command(aliases=["kw", "postit"])  # TODO: MP4s
    async def kowalski(self, ctx, *, text: commands.clean_content(use_nicknames=True, remove_markdown=True, fix_channel_mentions=True)):
        """Kowlalski tapping."""
        text = self.parse_text(text)
    ...
    async def letmein(self, ctx, *, text: commands.clean_content(use_nicknames=True, remove_markdown=True, fix_channel_mentions=True)):
        """LET ME IN."""
        text = self.parse_text(text)
    ...
    async def madethis(self, ctx, user: discord.Member, user2: discord.Member = None):
        ...
        data = await self.get(
            ctx,
            f"""/madethis?avatar1={user.avatar_url_as(static_format="png")}{f"&avatar2={user2.avatar_url_as(static_format='png')}" if user2 is not None else ""}""",
        )
    ...
    @commands.check(tokencheck)
    @commands.command(aliases=["magick"])  # Support other urls soon
    async def magickify(self, ctx, image: ImageFinder = None):
        """Peform magik (liquid rescale)."""
        if image is None:
            image = await ImageFinder().search_for_images(ctx)
        image = image[0]
    ...
    @commands.check(tokencheck)
    @commands.command()
    async def master(self, ctx, *, text: commands.clean_content(use_nicknames=True, remove_markdown=True, fix_channel_mentions=True)):
        """Yes master!.
    ...
    async def meme(
        ...
        top_text: commands.clean_content(use_nicknames=True, remove_markdown=True, fix_channel_mentions=True),
        bottom_text: commands.clean_content(use_nicknames=True, remove_markdown=True, fix_channel_mentions=True),
        ...
        data = await self.get(ctx, f"/meme?avatar1={image}&top_text={top_text}&bottom_text={bottom_text}{clr}{fnt}")
        if isinstance(data, dict):
            return await self.send_error(ctx, data)
        data.name = "meme.png"
        await self.send_img(ctx, discord.File(data))
    ...
    @commands.check(tokencheck)
    @commands.command()
    async def note(self, ctx, *, text: commands.clean_content(use_nicknames=True, remove_markdown=True, fix_channel_mentions=True)):
        """Pass a note back."""
        text = self.parse_text(text)
    ...
    @commands.check(tokencheck)
    @commands.command()
    async def nothing(self, ctx, *, text: commands.clean_content(use_nicknames=True, remove_markdown=True, fix_channel_mentions=True)):
        """Woah!.
    ...
    @commands.check(tokencheck)
    @commands.command()
    async def ohno(self, ctx, *, text: commands.clean_content(use_nicknames=True, remove_markdown=True, fix_channel_mentions=True)):
        """Oh no, it's stupid!."""
        text = self.parse_text(text)
    ...
    @commands.check(tokencheck)
    @commands.command()
    async def piccolo(self, ctx, *, text: commands.clean_content(use_nicknames=True, remove_markdown=True, fix_channel_mentions=True)):
        """Piccolo."""
        text = self.parse_text(text)
    ...
    @commands.check(tokencheck)
    @commands.command()
    async def plan(self, ctx, *, text: commands.clean_content(use_nicknames=True, remove_markdown=True, fix_channel_mentions=True)):
        """Gru makes a plan.
    ...
    @commands.check(tokencheck)
    @commands.command()
    async def presentation(self, ctx, *, text: commands.clean_content(use_nicknames=True, remove_markdown=True, fix_channel_mentions=True)):
    ...
    async def quote(
        ...
        *,
        ...
        user = user or ctx.author
        text = self.parse_text(text)
        data = await self.get(ctx, f"/quote?avatar1={user.avatar_url_as(static_format='png')}&username1={user.name}&text={text}")
        if isinstance(data, dict):
            return await self.send_error(ctx, data)
        data.name = "quote.png"
        await self.send_img(ctx, discord.File(data))
    ...
    @commands.check(tokencheck)
    @commands.command()
    async def robloxav(self, ctx, image: ImageFinder = None):
    ...
    @commands.check(tokencheck)
    @commands.command()
    async def savehumanity(self, ctx, *, text: commands.clean_content(use_nicknames=True, remove_markdown=True, fix_channel_mentions=True)):
    ...
    async def screams(self, ctx, user: discord.Member, user2: discord.Member = None):
        ...
        **Screams**
        ...
        data = await self.get(
            ctx,
            f"""/screams?avatar1={user.avatar_url_as(static_format="png")}{f"&avatar2={user2.avatar_url_as(static_format='png')}" if user2 is not None else ""}""",
        )
    ...
    @commands.check(tokencheck)
    @commands.command()
    async def shit(self, ctx, *, text: commands.clean_content(use_nicknames=True, remove_markdown=True, fix_channel_mentions=True)):
        """I stepped in crap."""
        text = self.parse_text(text)
    ...
    @commands.check(tokencheck)
    @commands.command()
    async def slapsroof(self, ctx, *, text: commands.clean_content(use_nicknames=True, remove_markdown=True, fix_channel_mentions=True)):
    ...
    @commands.check(tokencheck)
    @commands.command()
    async def sneakyfox(self, ctx, *, text: commands.clean_content(use_nicknames=True, remove_markdown=True, fix_channel_mentions=True)):
        """That sneaky fox.
    ...
    @commands.check(tokencheck)
    @commands.command()
    async def spank(self, ctx, user: discord.User, user2: discord.User = None):
        """*spanks*."""
        user2 = user2 or ctx.author
        (user, user2) = (user2, user)
        data = await self.get(
            ctx,
            f"""/spank?avatar1={user.avatar_url_as(static_format="png")}{f"&avatar2={user2.avatar_url_as(static_format='png')}" if user2 is not None else ""}""",
        )
    ...
    @commands.check(tokencheck)
    @commands.command()
    async def stroke(self, ctx, *, text: commands.clean_content(use_nicknames=True, remove_markdown=True, fix_channel_mentions=True)):
    ...
    @commands.check(tokencheck)
    @commands.command()
    async def surprised(self, ctx, *, text: commands.clean_content(use_nicknames=True, remove_markdown=True, fix_channel_mentions=True)):
        """Pikasuprised.
    ...
    async def sword(
        ...
        *,
        ...
        data = await self.get(ctx, f"/sword?avatar1={user.avatar_url_as(static_format='png')}&username1={user.name}&text={text}")
        if isinstance(data, dict):
            return await self.send_error(ctx, data)
        data.name = "sword.png"
        await self.send_img(ctx, discord.File(data))
    ...
    @commands.check(tokencheck)
    @commands.command()
    async def thesearch(self, ctx, *, text: commands.clean_content(use_nicknames=True, remove_markdown=True, fix_channel_mentions=True)):
    ...
    async def tweet(
        ...
        *,
        ...
        text: commands.clean_content(use_nicknames=True, remove_markdown=True, fix_channel_mentions=True)ing. Text to show on the generated image.

        """
        text = self.parse_text(text)
        user = user or ctx.author
        data = await self.get(ctx, f"/tweet?avatar1={user.avatar_url_as(static_format='png')}&username1={user.display_name}&username2={user.name}&text={text}")
        if isinstance(data, dict):
            return await self.send_error(ctx, data)
        data.name = "tweet.png"
        await self.send_img(ctx, discord.File(data))
    ...
    async def unpopular(
        ...
        *,
        ...
        user = user or ctx.author
        text = self.parse_text(text)
        data = await self.get(ctx, f"/unpopular?avatar1={user.avatar_url_as(static_format='png')}&username1={user.name}&text={text}")
        if isinstance(data, dict):
            return await self.send_error(ctx, data)
    ...
    @commands.check(tokencheck)
    @commands.command()
    async def violence(self, ctx, *, text: commands.clean_content(use_nicknames=True, remove_markdown=True, fix_channel_mentions=True)):
    ...
    @commands.check(tokencheck)
    @commands.command()
    async def violentsparks(self, ctx, *, text: commands.clean_content(use_nicknames=True, remove_markdown=True, fix_channel_mentions=True)):
        """Some violent sparks.
    ...
    @commands.check(tokencheck)
    @commands.command()
    async def vr(self, ctx, *, text: commands.clean_content(use_nicknames=True, remove_markdown=True, fix_channel_mentions=True)):
    ...
    @commands.check(tokencheck)
    @commands.command()
    async def walking(self, ctx, *, text: commands.clean_content(use_nicknames=True, remove_markdown=True, fix_channel_mentions=True)):
        """Walking Meme."""
        text = self.parse_text(text)
    ...
    async def whothisis(
        ...
        ctx,
        user: typing.Optional[discord.Member],
        username: commands.clean_content(use_nicknames=True, remove_markdown=True, fix_channel_mentions=True),
    ):
        """Who this is."""
        user = user or ctx.author
        data = await self.get(ctx, f"/whothisis?avatar1={user.avatar_url_as(static_format='png')}&text={username}")
        if isinstance(data, dict):
            return await self.send_error(ctx, data)
    ...
    async def youtube(
        ...
        *,
        ...
        user = user or ctx.author
        text = self.parse_text(text)
        data = await self.get(ctx, f"/youtube?avatar1={user.avatar_url_as(static_format='png')}&username1={user.name}&text={text}")
        if isinstance(data, dict):
            return await self.send_error(ctx, data)
    ...
    @commands.check(tokencheck)
    @commands.command()
    async def wwe(self, ctx, *, text: commands.clean_content(use_nicknames=True, remove_markdown=True, fix_channel_mentions=True)):
        """WWE Meme.
    ...
    @commands.check(tokencheck)
    @commands.command()
    async def farmer(self, ctx, *, text: commands.clean_content(use_nicknames=True, remove_markdown=True, fix_channel_mentions=True)):
        """Farmer.
    ...
    @commands.check(tokencheck)
    @commands.command()
    async def godwhy(self, ctx, *, text: commands.clean_content(use_nicknames=True, remove_markdown=True, fix_channel_mentions=True)):
        """God why."""
        text = self.parse_text(text)
    ...
    @commands.check(tokencheck)
    @commands.command()
    async def keepyourdistance(self, ctx, *, text: commands.clean_content(use_nicknames=True, remove_markdown=True, fix_channel_mentions=True)):
        """Keep your distance."""
        text = self.parse_text(text)
    ...
    @commands.check(tokencheck)
    @commands.command()
    async def theoffice(self, ctx, *, text: commands.clean_content(use_nicknames=True, remove_markdown=True, fix_channel_mentions=True)):
        """The office.
    ...
    async def emergencymeeting(self, ctx, *, text: commands.clean_content(use_nicknames=True, remove_markdown=True, fix_channel_mentions=True)):
