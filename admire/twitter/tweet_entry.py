...
class TweetEntry:
    ...
    def __repr__(self) -> str:
        return f"<TweetEntry twitter_name={self.twitter_name} twitter_id={self.twitter_id}>"
    ...
    def from_json(cls, data: dict[str, Any]) -> TweetEntry:
        ...
        return cls(twitter_id=data.get("twitter_id"), twitter_name=data.get("twitter_name"), channels=channel_obj, last_tweet=data.get("last_tweet"))
...
class ChannelData:
    ...
    def __str__(self) -> str:
        return f"Replies: {self.replies} - ReTweets: {self.retweets} - Custom Embeds: {self.embeds}"

    def to_json(self) -> dict[str, Any]:
        return {"guild": self.guild, "channel": self.channel, "replies": self.replies, "retweets": self.retweets, "embeds": self.embeds}
