...
from melanie.vendor.disputils import BotConfirmation, BotEmbedPaginator, BotMultipleChoice

bot = commands.Bot("+")


@bot.command()
async def paginate(ctx) -> None:
    embeds = [
