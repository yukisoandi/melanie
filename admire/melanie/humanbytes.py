...
"""Bytes-to-human / human-to-bytes converter. Based on: http://goo.gl/kTQMs
...
def bytes2human(n: int, format: str = "%(value).1f %(symbol)s", symbols: Union[str, tuple[str, ...]] = "customary") -> str:
    ...
    return format % {"symbol": symbols[0], "value": n}


def human2bytes(s) -> int:
