...
#   timestamp: 2023-08-09T09:23:58+00:00
...
class TwitterUserinfoResult(BaseModel, extra="allow"):
...
class User(BaseModel):
    result: TwitterUserinfoResult | None
...
class UserByScreenNameModel(BaseModel):
    data: Data | None
