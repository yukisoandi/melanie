...
#   timestamp: 2023-09-03T16:34:28+00:00
...
class CurrentTitleSettingsImages(BaseModel):
...
class DatumMap(BaseModel):
    name: str | None
    id: str | None


class ActRankWin(BaseModel):
    patched_tier: str | None
    tier: int | None


class E3A3(BaseModel):
    error: str | None
...
class E1A1(BaseModel):
    ...
    act_rank_wins: list[ActRankWin] | None
    old: bool | None
...
class MMRData(BaseModel):
    name: str | None
    tag: str | None
    current_data: CurrentData | None
    highest_rank: HighestRank | None
    by_season: dict[str, E1A1] | None
...
class CurrentTitleSettings(BaseModel):
    ...
    images: CurrentTitleSettingsImages | None
