...
class AntiSpam:
    ...
    Can be intialized with a custom set of intervals These should be
    provided as a list of tuples in the form (timedelta, quantity)

    Where quantity represents the maximum amount of times something
    should be allowed in an interval.
    ...
    def stamp(self) -> None:
        """Use this to mark an event that counts against the intervals as
        happening now.
        """
