...
def bordered(*columns: Sequence[str], ascii_border: bool = False) -> str:
    ...
    *columns : `sequence` of `str`
    ...
    """
    borders = {
        "TL": "+" if ascii_border else "┌",
        "TR": "+" if ascii_border else "┐",
        "BL": "+" if ascii_border else "└",
        "BR": "+" if ascii_border else "┘",
        "HZ": "-" if ascii_border else "─",
        "VT": "|" if ascii_border else "│",
...
def pagify(
    ...
    *,
    ...
    while len(in_text) > page_length:
        ...
        to_send = escape(in_text[:closest_delim], mass_mentions=True) if escape_mass_mentions else in_text[:closest_delim]
...
def humanize_list(items: Sequence[str], *, locale: Optional[str] = None, style: str = "standard") -> str:
    ...
    .. testsetup::
        ...
        from .chat_formatting import humanize_list
    ...
    """
    from melaniebot.core.i18n import get_babel_locale
...
def humanize_timedelta(*, timedelta: Optional[datetime.timedelta] = None, seconds: Optional[SupportsInt] = None) -> str:
    ...
    try:
        ...
        msg = "You must provide either a timedelta or a number of seconds"
...
def humanize_number(val: Union[int, float], override_locale=None) -> str:
    ...
    """
    from melaniebot.core.i18n import get_babel_regional_format
