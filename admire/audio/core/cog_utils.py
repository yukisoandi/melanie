...
from audio.converters import get_lazy_converter, get_playlist_converter
...
class DataWriter:
    ...
    def write_boolean(self, b) -> None:
        enc = struct.pack("B", 1 if b else 0)
        self.write_byte(enc)

    def write_unsigned_short(self, s) -> None:
        enc = struct.pack(">H", s)
        self._write(enc)
    ...
    def write_utf(self, s):
        ...
        if byte_len > 65535:
            msg = "UTF string may not exceed 65535 bytes!"
